...
/**
    Program Name: DiceSimulationDoWhileLoop.java
    Description: This class simulates rolling a pair of dice 10,000 times
    and counts the number of times doubles of are rolled for
    each different pair of doubles.
    Inputs: None
    Outputs: Display results of 10000 rolls.
    Preconditions: NA
    Postconditions: NA
*/
...
public class DiceSimulationDoWhileLoop
{
   public static void main(String[] args)
   {
      ...
      while (count < NUMBER)
      {
         ...
         if (die1Value == die2Value)  //Check Die Values for Matches
         {
            if (die1Value == 1)
            {
               snakeEyes++;
