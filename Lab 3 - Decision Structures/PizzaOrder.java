...
/**
    ...
    Description: This program allows the user to order a pizza.
    Inputs: 
    Outputs: Display final order and price.
...
public class PizzaOrder
{
  ...
  { 
    ...
    {
       System.out.println("Warning: Invalid Size Entered. \nA 12 inch pizza will be made.");
       inches = 12;
       cost = 12.99;
    }
    ...
    switch (crustType)
    {
      ...
      case 'T': 
         ...
         break;
      default:  
         System.out.println("Invalid Crust Selection. " +
                   "Hand-tossed crust selected.");
         crust = "Hand-tossed"; 
         break;
    }
    ...
    if (discount == true)
    {
      System.out.println("Discount Applied: -$2.00");
      cost = cost - 2;
    }
